...
export const MagicWandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-2.064.222m4.128 0a3 3 0 0 1-2.064.222m2.064 0a3 3 0 0 0 2.064-.222m-4.128 0 2.064 2.064a3 3 0 0 0 4.242 0l4.242-4.242a3 3 0 0 0 0-4.242l-2.064-2.064a3 3 0 0 0-4.242 0L9.53 16.122Z" />
    </svg>
);
...
export const SquareStackIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L12 15.25l5.571-3m0 0L21.75 12l-4.179-2.25m0 0-5.571 3-5.571-3m11.142 0L12 6.75l-5.571 3" />
    </svg>
);
...
export const SignalIcon: React.FC<{ bars: number }> = ({ bars }) => {
    return (
      <div className={`flex items-end space-x-0.5 h-3`}>
        <div className={`w-1 transition-all ${bars >= 1 ? 'h-1/4' : 'h-0'} bg-current`}></div>
        <div className={`w-1 transition-all ${bars >= 2 ? 'h-2/4' : 'h-0'} bg-current`}></div>
        <div className={`w-1 transition-all ${bars >= 3 ? 'h-3/4' : 'h-0'} bg-current`}></div>
        <div className={`w-1 transition-all ${bars >= 4 ? 'h-full' : 'h-0'} bg-current`}></div>
      </div>
    );
};
  
export const WifiIcon: React.FC<{ bars: number }> = ({ bars }) => (
    <svg className={`w-4 h-4`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 12.55a11 11 0 0 1 14.08 0" opacity={bars >= 1 ? 1 : 0.2}></path>
      <path d="M8.5 16.05a6 6 0 0 1 7 0" opacity={bars >= 2 ? 1 : 0.2}></path>
      <path d="M12 19.5a1.5 1.5 0 0 1 0 .01" opacity={bars >= 3 ? 1 : 0.2}></path>
    </svg>
);
